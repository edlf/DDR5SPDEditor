...
unsigned short TimeToTicksDDR5(const unsigned int time,
...
unsigned short TicksToTimeDDR5(const unsigned int ticks,
  ...
  double time =
      (S10E6 * ticks - S10E6) / ((1000 - correctionFactor) * frequency);
...
void SetCLSupportedDDR5(ddr5_structs::CAS &clSupported, unsigned short cl,
                        bool supported) {
...
bool IsCLSupportedDDR5(const ddr5_structs::CAS &clSupported,
                       unsigned short cl) {
  unsigned int mask[] = {1, 2, 4, 8, 16, 32, 64, 128};
