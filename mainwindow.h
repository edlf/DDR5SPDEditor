...
class MainWindow : public QMainWindow {
 ...
 private slots:
  ...
  void on_spinBoxtCCD_L_LCLK_Ticks_valueChanged(int);
  void on_spinBoxtCCD_L_LCLK_valueChanged(int);
  void on_spinBoxtCCD_L_Ticks_valueChanged(int);
  void on_spinBoxtCCD_L_valueChanged(int);
  void on_spinBoxtCCD_L_WTR_LCLK_Ticks_valueChanged(int);
  void on_spinBoxtCCD_L_WTR_LCLK_valueChanged(int);
  void on_spinBoxtCCD_L_WTR_Ticks_valueChanged(int);
  void on_spinBoxtCCD_L_WTR_valueChanged(int);
  void on_spinBoxtCCD_S_WTR_LCLK_Ticks_valueChanged(int);
  void on_spinBoxtCCD_S_WTR_LCLK_valueChanged(int);
  void on_spinBoxtCCD_S_WTR_Ticks_valueChanged(int);
  void on_spinBoxtCCD_S_WTR_valueChanged(int);
  void on_spinBoxtCCD_L_WR_LCLK_Ticks_valueChanged(int);
  void on_spinBoxtCCD_L_WR_LCLK_valueChanged(int);
  void on_spinBoxtCCD_L_WR_Ticks_valueChanged(int);
  void on_spinBoxtCCD_L_WR_valueChanged(int);
  void on_spinBoxtCCD_L_WR2_LCLK_Ticks_valueChanged(int);
  void on_spinBoxtCCD_L_WR2_LCLK_valueChanged(int);
  void on_spinBoxtCCD_L_WR2_Ticks_valueChanged(int);
  void on_spinBoxtCCD_L_WR2_valueChanged(int);
  void on_spinBoxtFAW_LCLK_Ticks_valueChanged(int);
  void on_spinBoxtFAW_LCLK_valueChanged(int);
  void on_spinBoxtFAW_Ticks_valueChanged(int);
  void on_spinBoxtFAW_valueChanged(int);
  void on_spinBoxtRAS_Ticks_valueChanged(int);
  void on_spinBoxtRAS_valueChanged(int);
  void on_spinBoxtRC_Ticks_valueChanged(int);
  void on_spinBoxtRC_valueChanged(int);
  void on_spinBoxtRCD_Ticks_valueChanged(int);
  void on_spinBoxtRCD_valueChanged(int);
  void on_spinBoxtRFC_Ticks_valueChanged(int);
  void on_spinBoxtRFC_valueChanged(int);
  void on_spinBoxtRFC1_Ticks_valueChanged(int);
  void on_spinBoxtRFC1_valueChanged(int);
  void on_spinBoxtRFC2_Ticks_valueChanged(int);
  void on_spinBoxtRFC2_valueChanged(int);
  void on_spinBoxtRP_Ticks_valueChanged(int);
  void on_spinBoxtRP_valueChanged(int);
  void on_spinBoxtRRD_L_LCLK_Ticks_valueChanged(int);
  void on_spinBoxtRRD_L_LCLK_valueChanged(int);
  void on_spinBoxtRRD_L_Ticks_valueChanged(int);
  void on_spinBoxtRRD_L_valueChanged(int);
  void on_spinBoxtRTP_LCLK_Ticks_valueChanged(int);
  void on_spinBoxtRTP_LCLK_valueChanged(int);
  void on_spinBoxtRTP_Ticks_valueChanged(int);
  void on_spinBoxtRTP_valueChanged(int);
  void on_spinBoxtWR_Ticks_valueChanged(int);
  void on_spinBoxtWR_valueChanged(int);

  void on_spinBoxtAA_Ticks_editingFinished();
  void on_spinBoxtAA_editingFinished();
  void on_spinBoxtCCD_L_WR2_LCLK_Ticks_editingFinished();
  void on_spinBoxtCCD_L_WR2_LCLK_editingFinished();
  void on_spinBoxtCCD_L_WR2_Ticks_editingFinished();
  void on_spinBoxtCCD_L_WR2_editingFinished();
  void on_spinBoxtCCD_L_WR_LCLK_Ticks_editingFinished();
  void on_spinBoxtCCD_L_WR_LCLK_editingFinished();
  void on_spinBoxtCCD_L_WR_Ticks_editingFinished();
  void on_spinBoxtCCD_L_WR_editingFinished();
  void on_spinBoxtCCD_L_LCLK_Ticks_editingFinished();
  void on_spinBoxtCCD_L_LCLK_editingFinished();
  void on_spinBoxtCCD_L_Ticks_editingFinished();
  void on_spinBoxtCCD_L_WTR_LCLK_Ticks_editingFinished();
  void on_spinBoxtCCD_L_WTR_LCLK_editingFinished();
  void on_spinBoxtCCD_L_WTR_Ticks_editingFinished();
  void on_spinBoxtCCD_L_WTR_editingFinished();
  void on_spinBoxtCCD_L_editingFinished();
  void on_spinBoxtCCD_S_WTR_LCLK_Ticks_editingFinished();
  void on_spinBoxtCCD_S_WTR_LCLK_editingFinished();
  void on_spinBoxtCCD_S_WTR_Ticks_editingFinished();
  void on_spinBoxtCCD_S_WTR_editingFinished();
  void on_spinBoxtFAW_LCLK_Ticks_editingFinished();
  void on_spinBoxtFAW_LCLK_editingFinished();
  void on_spinBoxtFAW_Ticks_editingFinished();
  void on_spinBoxtFAW_editingFinished();
  void on_spinBoxtRAS_Ticks_editingFinished();
  void on_spinBoxtRAS_editingFinished();
  void on_spinBoxtRCD_Ticks_editingFinished();
  void on_spinBoxtRCD_editingFinished();
  void on_spinBoxtRC_Ticks_editingFinished();
  void on_spinBoxtRC_editingFinished();
  void on_spinBoxtRFC1_Ticks_editingFinished();
  void on_spinBoxtRFC1_editingFinished();
  void on_spinBoxtRFC2_Ticks_editingFinished();
  void on_spinBoxtRFC2_editingFinished();
  void on_spinBoxtRFC_Ticks_editingFinished();
  void on_spinBoxtRFC_editingFinished();
  void on_spinBoxtRP_Ticks_editingFinished();
  void on_spinBoxtRP_editingFinished();
  void on_spinBoxtRRD_L_LCLK_Ticks_editingFinished();
  void on_spinBoxtRRD_L_LCLK_editingFinished();
  void on_spinBoxtRRD_L_Ticks_editingFinished();
  void on_spinBoxtRRD_L_editingFinished();
  void on_spinBoxtRTP_LCLK_Ticks_editingFinished();
  void on_spinBoxtRTP_LCLK_editingFinished();
  void on_spinBoxtRTP_Ticks_editingFinished();
  ...
  void on_sbtCCD_L_WR_XMP1_valueChanged(int);
  void on_sbtCCD_L_WR_LCLK_XMP1_valueChanged(int);
  void on_sbtCCD_L_WR2_XMP1_valueChanged(int);
  void on_sbtCCD_L_WR2_LCLK_XMP1_valueChanged(int);
  ...
  void on_sbtCCD_L_WR_XMP1_editingFinished();
  void on_sbtCCD_L_WR_LCLK_XMP1_editingFinished();
  void on_sbtCCD_L_WR2_XMP1_editingFinished();
  void on_sbtCCD_L_WR2_LCLK_XMP1_editingFinished();
  ...
  void on_sbtCCD_L_WR_XMP2_valueChanged(int);
  void on_sbtCCD_L_WR_LCLK_XMP2_valueChanged(int);
  void on_sbtCCD_L_WR2_XMP2_valueChanged(int);
  void on_sbtCCD_L_WR2_LCLK_XMP2_valueChanged(int);
  ...
  void on_sbtCCD_L_WR_XMP2_editingFinished();
  void on_sbtCCD_L_WR_LCLK_XMP2_editingFinished();
  void on_sbtCCD_L_WR2_XMP2_editingFinished();
  void on_sbtCCD_L_WR2_LCLK_XMP2_editingFinished();
  ...
  void on_sbtCCD_L_WR_XMP3_valueChanged(int);
  void on_sbtCCD_L_WR_LCLK_XMP3_valueChanged(int);
  void on_sbtCCD_L_WR2_XMP3_valueChanged(int);
  void on_sbtCCD_L_WR2_LCLK_XMP3_valueChanged(int);
  ...
  void on_sbtCCD_L_WR_XMP3_editingFinished();
  void on_sbtCCD_L_WR_LCLK_XMP3_editingFinished();
  void on_sbtCCD_L_WR2_XMP3_editingFinished();
  void on_sbtCCD_L_WR2_LCLK_XMP3_editingFinished();
  ...
  void on_sbtCCD_L_WR_XMPU1_valueChanged(int);
  void on_sbtCCD_L_WR_LCLK_XMPU1_valueChanged(int);
  void on_sbtCCD_L_WR2_XMPU1_valueChanged(int);
  void on_sbtCCD_L_WR2_LCLK_XMPU1_valueChanged(int);
  ...
  void on_sbtCCD_L_WR_XMPU1_editingFinished();
  void on_sbtCCD_L_WR_LCLK_XMPU1_editingFinished();
  void on_sbtCCD_L_WR2_XMPU1_editingFinished();
  void on_sbtCCD_L_WR2_LCLK_XMPU1_editingFinished();
  ...
  void on_sbtCCD_L_WR_XMPU2_valueChanged(int);
  void on_sbtCCD_L_WR_LCLK_XMPU2_valueChanged(int);
  void on_sbtCCD_L_WR2_XMPU2_valueChanged(int);
  void on_sbtCCD_L_WR2_LCLK_XMPU2_valueChanged(int);
  ...
  void on_sbtCCD_L_WR_XMPU2_editingFinished();
  void on_sbtCCD_L_WR_LCLK_XMPU2_editingFinished();
  void on_sbtCCD_L_WR2_XMPU2_editingFinished();
  void on_sbtCCD_L_WR2_LCLK_XMPU2_editingFinished();
  ...
  void on_sbtCCD_L_WR_EXPO1_valueChanged(int);
  void on_sbtCCD_L_WR2_EXPO1_valueChanged(int);
  ...
  void on_sbtCCD_L_WR_EXPO1_editingFinished();
  void on_sbtCCD_L_WR2_EXPO1_editingFinished();
  ...
  void on_sbtCCD_L_WR_EXPO2_valueChanged(int);
  void on_sbtCCD_L_WR2_EXPO2_valueChanged(int);
  ...
  void on_sbtCCD_L_WR_EXPO2_editingFinished();
  void on_sbtCCD_L_WR2_EXPO2_editingFinished();
